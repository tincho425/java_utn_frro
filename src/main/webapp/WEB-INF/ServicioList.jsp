...
<html>
	<head>
	    ...
	    <%
	    	...
	    	request.setAttribute("currentPage", "servicios");
	...
	<body class="text-center">
		...
		<main class="container">
			<div class="d-flex flex-row-reverse">
				<a href="./nuevo-servicio" class="btn btn-primary">Nuevo servicio</a>
			</div>
		            ...
		            <tr>
		              ...
		              <td class="d-flex justify-content-evenly">
			         	<form method="post" action="./servicios">
			         		<input type="hidden" name="id_servicio" value="<%=servicio.getId()%>" />
			         	...
			         	<a href="./servicio-nuevo?edit=<%=servicio.getId()%>">
